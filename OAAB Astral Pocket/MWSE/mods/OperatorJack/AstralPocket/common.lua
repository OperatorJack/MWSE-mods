...
this.spellIds = {TeleportToAstralPocket = "OJ_AP_TeleportToAstralPocket"}
...
this.journalIds = {QuestOne = "OJ_AP_AstrologicalElementsJournal"}

this.cell = {
    id = "Astral Pocket",
    position = {2025, -110, 14439},
    orientation = {x = 0, y = 0, z = 138}
}
