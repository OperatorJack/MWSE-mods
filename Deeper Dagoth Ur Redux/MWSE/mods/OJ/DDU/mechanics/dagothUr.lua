...
local function onHeartSimulate(e)
    ...
    heart = heart or tes3.getReference(heartId)
...
stagesDagothUr = {
    ["firstStage"] = {
        initialize = function()
            ...
            dagothUr = tes3.getReference(
                           common.data.mechanics.dagothUr.ids.dagothUrs
                               .dagoth_ur_2)
            ...
            local spawnCreatures = function()
                local ref1 = tes3.createReference({
                    object = common.data.mechanics.dagothUr.ids.creatures
                        .ashSlave,
                    position = {263, 734, 2232},
                    orientation = tes3.player.orientation,
                    cell = tes3.player.cell
                }) ---@cast ref1 tes3reference
                ...
                local ref4 = tes3.createReference({
                    ...
                    orientation = tes3.player.orientation,
                    cell = tes3.player.cell
                }) ---@cast ref4 tes3reference

                ref1.mobile:startCombat(tes3.mobilePlayer)
                ref2.mobile:startCombat(tes3.mobilePlayer)
                ref3.mobile:startCombat(tes3.mobilePlayer)
                ref4.mobile:startCombat(tes3.mobilePlayer)
            end
            ...
            timer.start({
                ...
                callback = function()
                    barrier:disable()
                    tes3.messageBox(
                        "The barrier to the next platform dissipates, opening the way to continue. However, you feel yourself being moved through the cavern before you can continue.")
    ...
    ["secondStage"] = {
        initialize = function()
            ...
            timer.start({
                ...
                callback = function()
                    local orientationRad =
                        tes3vector3.new(math.rad(0), math.rad(0), math.rad(337))
            ...
            for _, heartwight in pairs(common.data.mechanics.dagothUr
                                           .heartwights) do

                local orientationRad = tes3vector3.new(math.rad(
                                                           heartwight.orientation[1]),
                                                       math.rad(
                                                           heartwight.orientation[2]),
                                                       math.rad(
                                                           heartwight.orientation[3]))
                ...
                local heartwightRefBaseHealth =
                    heartwightRef.mobile.health.current
                tes3.modStatistic({
                ...
                local heartwightRefBaseMagicka =
                    heartwightRef.mobile.magicka.current
                tes3.modStatistic({
                    reference = heartwightRef,
                    name = "magicka",
                ...
                heartwightRef.mobile:startCombat(tes3.mobilePlayer)
            end
