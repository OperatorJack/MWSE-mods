...
this.data = {
    ...
    spellIds = {ascendedSleeperHeal = "hearth heal"},
    diseaseIds = {
        blackHeartBlight = {
            id = "black-heart blight",
            name = "Black-Heart Blight"
        },
        ashWoeBlight = {id = "ash woe blight", name = "Ash Woe Blight"},
        ashChancreBlight = {id = "ash-chancre", name = "Ash-chancre"},
        chanthraxBlight = {id = "chanthrax blight", name = "Chanthrax Blight"}
    },
    mechanics = {
        dagothUr = {
            ids = {
...
this.shouldPerformRandomEvent = function(percentChanceOfOccurence)
    if (math.random(-1, 101) <= percentChanceOfOccurence) then return true end
    return false
end
